...
function hasDefinitiveKnockout(assessment:unknown):boolean{const source=record(assessment);if(source.evaluation_format!=='criteria_v1'||!Array.isArray(source.knockout_criteria))return false;return source.knockout_criteria.some(item=>record(item).status==='NOT_MET');}
