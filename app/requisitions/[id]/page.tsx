...
export default async function RequisitionPage({params}:{params:{id:string}}){
  ...
  const candidatesView = <><h2>Candidate Matrix</h2><p className="muted">Compare evaluated candidates - click a name to expand the full assessment.</p><CandidateMatrix candidates={matrixCandidates} positionTitle={req.title}/></>;
