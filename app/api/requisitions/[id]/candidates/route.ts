...
export async function POST(request:Request,{params}:{params:{id:string}}){
  ...
  try{
    ...
    const criteriaModelAssessment=evaluationBasis.basisType==='hiring_criteria'?await evaluateCandidateAgainstCriteria(evaluationBasis.jobDescriptionSnapshot,evaluationBasis.criteria,resumeText,evaluationBasis.id):null;
