...
export function RequisitionViewToggle({
  ...
  return (
    <div className={`requisition-workspace ${view === 'candidates' ? 'candidates-active' : 'requisition-active'}${interviewsActive ? ' interviews-active' : ''}`}>
      {interviewsActive && (
        <style>{`@media(min-width:861px){.requisition-workspace.interviews-active{height:calc(100dvh - 190px);min-height:0;display:flex;flex-direction:column;overflow:hidden}.requisition-workspace.interviews-active>.requisition-view-tabs,.requisition-workspace.interviews-active>.requisition-title-row{flex:none}.requisition-workspace.interviews-active>.requisition-detail-view{display:flex;flex:1;min-height:0;flex-direction:column;overflow:hidden}.requisition-workspace.interviews-active .requisition-workspace-tabs{flex:none}.requisition-workspace.interviews-active .requisition-tab-panel.interviews-panel{display:block;flex:1;min-height:0;overflow:hidden}.requisition-workspace.interviews-active .requisition-tab-panel.interviews-panel>div{height:100%;min-height:0}.requisition-workspace.interviews-active .requisition-tab-panel.interviews-panel [data-interview-plan="selected"]{height:100%;min-height:0}}`}</style>
      )}
