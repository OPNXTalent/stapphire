      ...
      items: {
        ...
        properties: {
          ...
          areas: {
            ...
            maxItems: 4,
            uniqueItems: true,
            items: { type: 'string', enum: [...AREAS_OF_EVALUATION] }
          }
        }
      }
    }
