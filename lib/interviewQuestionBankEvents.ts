...
export const INTERVIEW_WORKSPACE_FOCUS_EVENT = 'stapphire:interview-workspace-focus';
export const INTERVIEW_WORKSPACE_CLEAR_EVENT = 'stapphire:interview-workspace-clear';
...
export type InterviewWorkspaceFocusDetail = { stage: InterviewStageId; positionTitle: string };
